function [deltaV_o] = transferDateOptimization(inputVec)
    ...
    global d_minimum d_maximum timeResult theta_vec initial_DeltaV;
    global thrustFunction thetaDotFunction timeFunction;
    global radiusFunction thetaDotSquareFunction timeFunction_nn;
